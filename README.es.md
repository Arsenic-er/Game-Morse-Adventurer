...
**v0.40.0**: Los capítulos 5–10 están implementados. El capítulo 5 completa el evento de luces NOVA—SORA—MORSE y su archivo; el 6 ofrece la expedición jugable a la colina. La investigación QSL del capítulo 7 conserva ambos relatos y la decisión final mediante un contacto verificable con SORA. La red ficticia de servicio público del capítulo 8 confirma por prioridad tres mensajes de simulacro limitados. El relevo de coordenadas Pixel Grid del capítulo 9 verifica cuadrícula ficticia, UTC, personas y control sin guardar texto libre. El concurso RUN / S&P del capítulo 10 ofrece cinco minutos sin conexión, seis contactos únicos, puntuación determinista, recuperación, repetición y mejor marca personal. Los capítulos 11–15 siguen planificados y no son jugables; no se representan emergencias, organismos, frecuencias de emergencia ni clasificaciones reales.
