...
- Las páginas persistentes de resultado y las entradas del libro de guardia incluyen indicativo, región, distancia, RST, propagación, equipo, WPM, precisión de transmisión, ritmo, número de repeticiones solicitadas y una revisión línea por línea de los intentos aceptados, rechazados y repetidos.
- Completar un QSO con la guía desactivada y sin abrir la ayuda visual cuenta como guardia independiente y concede 50 créditos adicionales sobre la recompensa base de 100.
...
La versión **v0.23.0** amplía toda la interfaz del juego al inglés, chino simplificado, chino tradicional, japonés, español, alemán y ruso. El español, alemán y ruso usan la fuente pixelada Press Start 2P con licencia OFL; el inglés, chino y japonés conservan Fusion Bold Pixel. También mantiene el entrenamiento regional de indicativos ficticios de v0.22: Todos conserva el conjunto anterior de ocho objetivos; Japón, Estados Unidos, China y Europa aportan ocho objetivos `SIM` únicos cada uno, desbloqueados como 2/4/6/8 en cuatro lecciones. La bolsa barajada, la exclusión de los cuatro objetivos recientes y el repaso de debilidades se mantienen dentro del conjunto desbloqueado de la región seleccionada. El esquema v3 de registros de práctica migra las partidas anteriores a Todos, restaura la región y su conjunto al recargar y borra toda la ventana de indicativos recientes al cambiar de región, sin alterar resultados acumulados, debilidades, puntuación formal, desbloqueos ni el progreso agregado de 19 lecciones. Cada revisión aceptada en `main` se empaqueta como artefacto portátil Windows x64 con suma de comprobación.
