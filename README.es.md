...
**v0.45.0**: Los capítulos 5–15 y el panel inicial de Open Station están implementados. La escucha del capítulo 11 convierte el silencio en una decisión acotada; el relevo de tormenta del capítulo 12 verifica un parte ficticio de revisión 2; las operaciones nocturnas del capítulo 13 completan tres ventanas; la promesa final del capítulo 14 cierra el relato fijo de SORA sin guardar prosa del jugador; el QSO ordinario del capítulo 15 sella la primera página y abre metas de Open Station. Todo sigue siendo ficticio y sin conexión, sin tráfico, organismos o frecuencias de emergencia reales, chat libre ni clasificaciones en línea.
