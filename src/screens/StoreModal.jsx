...
const TEXT = {
  "zh-CN": {
    ...
    starter: "初始设备", propagation: "传播修正", qsb: "衰落深度", noise: "接收噪声", close: "关闭商店",
  ...
  "zh-TW": {
    ...
    starter: "初始設備", propagation: "傳播修正", qsb: "衰落深度", noise: "接收雜訊", close: "關閉商店",
  ...
  ja: {
    ...
    starter: "初期装備", propagation: "伝搬補正", qsb: "フェージング深度", noise: "受信ノイズ", close: "ショップを閉じる",
  ...
  en: {
    ...
    starter: "Starter Equipment", propagation: "Propagation Modifier", qsb: "QSB Depth", noise: "Receiver Noise", close: "Close Store",
