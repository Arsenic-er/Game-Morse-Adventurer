...
const TEXT = {
  ...
  es: {
    ...
    vertical: "Reduce un 15 % la profundidad del QSB para una recepción más estable.", yagi: "Añade +1 nivel de propagación en contactos direccionales de larga distancia.",
    cwFilter: "Centra un paso de recepción de 500 Hz en el tono fijo de 650 Hz y reduce el ruido un 35 %, sin cambiar la propagación ni la decodificación CW.",
    usdrKit: "Un transceptor QRP CW multibanda ficticio inspirado en las ideas abiertas de uSDX/uSDR. DSP/AGC mejora la recepción; el juego permanece fijado en 21,060 MHz.",
  },
  de: {
    ...
    vertical: "Verringert die QSB-Tiefe um 15 % und stabilisiert das Empfangssignal.", yagi: "Erhöht die Ausbreitungsstufe für gerichtete Fernverbindungen um +1.",
    cwFilter: "Zentriert einen 500-Hz-Empfangsdurchlass auf dem festen 650-Hz-Ton und senkt das Rauschen um 35 %, ohne Ausbreitung oder CW-Dekodierung zu verändern.",
    usdrKit: "Ein fiktiver Multiband-QRP-CW-Transceiver, inspiriert von offenen uSDX/uSDR-Ideen. DSP/AGC verbessert den Empfang; gespielt wird weiterhin fest auf 21,060 MHz.",
  },
  ru: {
    ...
    vertical: "Уменьшает глубину QSB на 15 % для более стабильного приёма.", yagi: "Добавляет +1 к уровню прохождения при направленных дальних связях.",
    cwFilter: "Центрирует полосу приёма 500 Гц на фиксированном тоне 650 Гц и снижает шум на 35 %, не меняя прохождение и декодирование CW.",
    usdrKit: "Вымышленный многодиапазонный QRP CW-трансивер, вдохновлённый открытыми идеями uSDX/uSDR. DSP/AGC улучшает приём, а игровая частота остаётся 21,060 МГц.",
  },
};
