...
const TEXT = {
    ...
    chapters: [
      {
        ...
        code: "入门与存档",
        title: "建立你的第一座台站",
        summary: "新游戏会先建立独立存档。你的呼号、地点、设备和金钱都会随该存档保存。",
        cards: [
          ...
          { title: "读取存档", body: "点击“开始值守”后会先进入存档选择。卡片会显示呼号、所在地、当前电台、天线和金钱，选择后再进入管理中心。" },
      ...
      },
      {
        ...
        cards: [
          ...
          { title: "完成通联", body: "根据当前目标继续交换呼号与报告。成功后保存日志，结算金钱，并返回台站或开始下一次 QSO。" },
        ],
    ...
    chapters: [
      {
        ...
        code: "入門與存檔",
        title: "建立你的第一座臺站",
        summary: "新遊戲會先建立獨立存檔。你的呼號、地點、設備和金錢都會隨該存檔保存。",
        cards: [
          ...
          { title: "讀取存檔", body: "點擊「開始值守」後會先進入存檔選擇。卡片會顯示呼號、所在地、目前電臺、天線和金錢，選擇後再進入管理中心。" },
      ...
      },
      {
        ...
        cards: [
          ...
          { title: "完成通聯", body: "依照目前目標繼續交換呼號與報告。成功後保存日誌、結算金錢，並返回臺站或開始下一次 QSO。" },
        ],
    ...
    chapters: [
      {
        ...
        code: "入門とセーブ",
        title: "最初のステーションを作る",
        summary: "ニューゲームでは専用セーブを作成します。コールサイン、所在地、設備、所持金はセーブごとに保存されます。",
        cards: [
          ...
          { title: "セーブを読み込む", body: "「運用を開始」を選ぶとセーブ選択画面へ進みます。カードでコールサイン、所在地、無線機、アンテナ、所持金を確認して管理センターへ入ります。" },
      ...
      },
      {
        ...
        cards: [
          ...
          { title: "交信を完了する", body: "現在の目標に沿ってコールサインとレポートを交換します。成功後はログを保存し、所持金を精算して次の QSO へ進めます。" },
        ],
    ...
    chapters: [
      {
        ...
        summary: "A new game begins with a separate save. Your callsign, location, equipment, and money remain attached to that station.",
        cards: [
          ...
          { title: "Load a save", body: "Begin Watch opens save selection first. Each card shows its callsign, location, current radio, antenna, and money before you enter the management center." },
      ...
      },
      {
        ...
        cards: [
          ...
          { title: "Complete the QSO", body: "Follow the current objective to exchange callsigns and reports. After success, save the log, settle money, then return or start the next QSO." },
        ],
  ...
  es: {
    ...
    chapters: [
      {
        tab: "Iniciar guardia", code: "Conceptos básicos y partidas", title: "Construye tu primera estación", summary: "Una partida nueva comienza con un guardado independiente. Tu indicativo, ubicación, equipo y dinero permanecen vinculados a esa estación.",
        cards: [
          ...
          { title: "Carga una partida", body: "Iniciar guardia abre primero la selección de partidas. Cada tarjeta muestra indicativo, ubicación, radio, antena y dinero antes de entrar al centro de gestión." },
      ...
      },
      {
        ...
        cards: [
          ...
          { title: "Completa el QSO", body: "Sigue el objetivo actual para intercambiar indicativos e informes. Tras el éxito, guarda el registro, liquida los dinero y vuelve o inicia el siguiente QSO." },
        ],
  ...
  de: {
    ...
    chapters: [
      {
        tab: "Wache beginnen", code: "Grundlagen und Spielstände", title: "Baue deine erste Station", summary: "Ein neues Spiel beginnt mit einem eigenen Spielstand. Rufzeichen, Standort, Ausrüstung und Geld bleiben mit dieser Station verbunden.",
        cards: [
          ...
          { title: "Spielstand laden", body: "Wache beginnen öffnet zuerst die Spielstandauswahl. Jede Karte zeigt Rufzeichen, Standort, Funkgerät, Antenne und Geld, bevor du das Verwaltungszentrum betrittst." },
      ...
      },
      {
        ...
        cards: [
          ...
          { title: "QSO abschließen", body: "Folge dem aktuellen Ziel und tausche Rufzeichen und Rapporte aus. Speichere nach Erfolg das Log, rechne die Geld ab und kehre zurück oder starte das nächste QSO." },
        ],
  ...
  ru: {
    ...
    chapters: [
      {
        tab: "Начать вахту", code: "Основы и сохранения", title: "Создайте свою первую станцию", summary: "Новая игра начинается с отдельного сохранения. Позывной, место, оборудование и деньги остаются привязаны к этой станции.",
        cards: [
          ...
          { title: "Загрузите сохранение", body: "Начать вахту сначала открывает выбор сохранения. До входа в Центр управления каждая карточка показывает позывной, место, радиостанцию, антенну и деньги." },
      ...
      },
      {
        ...
        cards: [
          ...
          { title: "Завершите QSO", body: "Следуйте текущей задаче, чтобы обменяться позывными и рапортами. После успеха сохраните журнал, получите деньги, затем вернитесь или начните следующее QSO." },
        ],
