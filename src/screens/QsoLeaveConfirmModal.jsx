...
const QSO_LEAVE_TEXT = {
  "zh-CN": {
    ...
    unsavedBody: "本次通联已经完成但尚未保存。现在离开将丢弃通联日志和本次获得的全部金钱。",
  ...
  "zh-TW": {
    ...
    unsavedBody: "本次通聯已完成但尚未儲存。現在離開將捨棄通聯日誌與本次獲得的全部金錢。",
  ...
  ja: {
    ...
    unsavedBody: "交信は完了していますが、まだ保存されていません。いま退出すると、交信ログと獲得した報酬はすべて失われます。",
  ...
  en: {
    ...
    unsavedBody: "This QSO is complete but has not been saved. Leaving now will discard its log and all money earned from it.",
  ...
  es: {
    ...
    unsavedBody: "Este QSO ha finalizado, pero aún no se ha guardado. Si sales ahora, se perderán el registro y todos los dinero obtenidos.",
  ...
  de: {
    ...
    unsavedBody: "Dieses QSO ist abgeschlossen, aber noch nicht gespeichert. Beim Verlassen gehen der Logeintrag und alle verdienten Geld verloren.",
  ...
  ru: {
    ...
    unsavedBody: "QSO завершено, но ещё не сохранено. Если выйти сейчас, запись в журнале и все заработанные деньги будут потеряны.",
