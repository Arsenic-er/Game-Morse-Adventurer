...
const TEXT = {
  ...
  es: {
    title: "Práctica de CW", back: "Volver al inicio", settings: "Ajustes", independent: "Entrenamiento independiente · propagación desactivada",
    characterRx: "Recepción de caracteres", callsignRx: "Recepción de indicativos", manualTx: "Manipulador vertical", paddleTx: "Pala automática",
    listen: "Reproducir ejercicio", answer: "Escribe lo que copiaste", submit: "Evaluar intento", next: "Siguiente ejercicio", replay: "Reproducir entrada",
    visualOn: "Ocultar ayuda visual", visualOff: "Mostrar ayuda visual", target: "Objetivo", decoded: "Decodificado",
    fixedSpeed: "Velocidad del sistema", detectedSpeed: "Velocidad detectada", automaticSpeed: "Velocidad automática", correct: "Correcto", wrong: "Incorrecto", waiting: "Esperando entrada",
    attempts: "Intentos", correctCount: "Correctos", accuracy: "Precisión", rhythm: "Ritmo medio", weak: "Caracteres débiles", noWeak: "Ninguno",
    manualHint: "Mantén Espacio para manipular", paddleHint: "Z punto / X raya", sim: "Todos los indicativos son estaciones SIM ficticias generadas por el programa",
    session: "Esta sesión", lifetime: "Registro total", recordingTo: "Registrando en", sessionOnly: "Solo esta sesión · selecciona una partida para conservar los resultados",
    endSession: "Terminar sesión", summaryTitle: "Resumen de la sesión", summarySubtitle: "Esta sesión de práctica ha sido evaluada", continueTraining: "Seguir practicando", leavePractice: "Volver al inicio",
    difficulty: "Dificultad", guided: "Guiada", standard: "Estándar", challenge: "Desafío", lesson: "Lección", lessonProgress: "Progreso de lección",
    pass: "Lección superada", retry: "Objetivo no alcanzado — reintentar", unlocked: "Siguiente lección desbloqueada", completed: "Programa completado", switchLocked: "El cambio se aplicará en la siguiente ronda tras responder",
    lessonContents: "Contenido de la lección", introduced: "Nuevo en esta lección", practiceRange: "Banco de ejercicios", masteryProgress: "Progreso para superar esta lección",
    completedLessons: "Lecciones completadas", currentBlock: "Bloque puntuado actual", passRule: "Regla para aprobar", remainingQuestions: "Preguntas restantes", correctNeeded: "Aciertos necesarios",
    thresholdSecured: "Ya alcanzaste los aciertos necesarios; termina las preguntas restantes", cannotPass: "Este bloque ya no puede aprobarse; termínalo para reiniciar", blockProgressing: "Continúa este bloque puntuado", blockNotStarted: "Esta lección aún no ha empezado a puntuar",
    replayNoProgress: "Repasar una lección completada no avanza el bloque actual", curriculumOverview: "Programa",
    callsignRegion: "Región del indicativo", callsignRegions: { all: "Todas", japan: "Japón", usa: "Estados Unidos", china: "China", europe: "Europa" },
    weakReview: "Repaso de objetivos débiles", weakReviewActive: "Repaso en curso", weakReviewTargets: "Banco de repaso", weakReviewUnavailable: "Disponible tras fallar un objetivo",
    weakReviewRecoveryHint: "Los aciertos de repaso reducen el peso de debilidad del carácter", recoveredPoints: "Recuperado", remainingWeakness: "Debilidad restante",
    weakReviewComplete: "Repaso de objetivos débiles completado", weaknessMastered: "Objetivo débil dominado", weaknessMasteredDetail: "Su peso de debilidad es cero y no entrará en el siguiente repaso; el progreso de la lección formal no cambia", weakReviewNoProgress: "Se actualizó el registro total; el progreso de la lección formal no cambia", returnToLesson: "Volver a la lección",
  },
  de: {
    title: "CW-Training", back: "Zurück zum Titel", settings: "Einstellungen", independent: "Unabhängiges Training · Ausbreitung deaktiviert",
    characterRx: "Zeichenempfang", callsignRx: "Rufzeichenempfang", manualTx: "Handtaste", paddleTx: "Automatische Taste",
    listen: "Aufgabe abspielen", answer: "Mitgeschriebenen Text eingeben", submit: "Versuch bewerten", next: "Nächste Aufgabe", replay: "Eingabe abspielen",
    visualOn: "Visuelle Hilfe ausblenden", visualOff: "Visuelle Hilfe anzeigen", target: "Ziel", decoded: "Dekodiert",
    fixedSpeed: "Systemtempo", detectedSpeed: "Erkanntes Tempo", automaticSpeed: "Automatiktasten-Tempo", correct: "Richtig", wrong: "Nicht richtig", waiting: "Warte auf Eingabe",
    attempts: "Versuche", correctCount: "Richtig", accuracy: "Genauigkeit", rhythm: "Mittlerer Rhythmus", weak: "Schwache Zeichen", noWeak: "Keine",
    manualHint: "Leertaste zum Tasten halten", paddleHint: "Z Punkt / X Strich", sim: "Alle Rufzeichen sind programmgenerierte, fiktive SIM-Stationen",
    session: "Diese Sitzung", lifetime: "Gesamtstatistik", recordingTo: "Aufzeichnung in", sessionOnly: "Nur diese Sitzung · Spielstand wählen, um Ergebnisse zu behalten",
    endSession: "Sitzung beenden", summaryTitle: "Sitzungsübersicht", summarySubtitle: "Diese Übungssitzung wurde ausgewertet", continueTraining: "Weiter trainieren", leavePractice: "Zurück zum Titel",
    difficulty: "Schwierigkeit", guided: "Geführt", standard: "Standard", challenge: "Herausforderung", lesson: "Lektion", lessonProgress: "Lektionsfortschritt",
    pass: "Lektion bestanden", retry: "Ziel verfehlt — wiederholen", unlocked: "Nächste Lektion freigeschaltet", completed: "Lehrplan abgeschlossen", switchLocked: "Wechsel nach der Antwort in der nächsten Runde",
    lessonContents: "Lektionsinhalt", introduced: "Neu in dieser Lektion", practiceRange: "Aufgabenpool", masteryProgress: "Fortschritt zum Bestehen dieser Lektion",
    completedLessons: "Abgeschlossene Lektionen", currentBlock: "Aktueller Wertungsblock", passRule: "Bestehensregel", remainingQuestions: "Verbleibende Fragen", correctNeeded: "Benötigte richtige Antworten",
    thresholdSecured: "Benötigte richtige Antworten erreicht; restliche Fragen abschließen", cannotPass: "Dieser Block kann nicht mehr bestanden werden; abschließen zum Neustart", blockProgressing: "Diesen Wertungsblock fortsetzen", blockNotStarted: "Diese Lektion zählt noch nicht",
    replayNoProgress: "Das Wiederholen einer abgeschlossenen Lektion bringt den aktuellen Block nicht voran", curriculumOverview: "Lehrplan",
    callsignRegion: "Rufzeichenregion", callsignRegions: { all: "Alle", japan: "Japan", usa: "USA", china: "China", europe: "Europa" },
    weakReview: "Schwachstellen-Training", weakReviewActive: "Training läuft", weakReviewTargets: "Wiederholungspool", weakReviewUnavailable: "Nach einem Fehler verfügbar",
    weakReviewRecoveryHint: "Richtige Wiederholungsantworten senken die Schwächegewichtung des Zeichens", recoveredPoints: "Erholt", remainingWeakness: "Verbleibende Schwäche",
    weakReviewComplete: "Schwachstellen-Training abgeschlossen", weaknessMastered: "Schwachstelle gemeistert", weaknessMasteredDetail: "Die Schwächegewichtung ist jetzt null; das Zeichen kommt nicht in die nächste Wiederholung. Der formale Lektionsfortschritt bleibt unverändert", weakReviewNoProgress: "Gesamtstatistik aktualisiert; formaler Lektionsfortschritt unverändert", returnToLesson: "Zurück zur Lektion",
  },
  ru: {
    title: "Практика CW", back: "Назад к заставке", settings: "Настройки", independent: "Независимая тренировка · прохождение отключено",
    characterRx: "Приём знаков", callsignRx: "Приём позывных", manualTx: "Ручной ключ", paddleTx: "Автоматический ключ",
    listen: "Воспроизвести задание", answer: "Введите принятый текст", submit: "Оценить попытку", next: "Следующее задание", replay: "Воспроизвести ввод",
    visualOn: "Скрыть визуальную помощь", visualOff: "Показать визуальную помощь", target: "Цель", decoded: "Декодировано",
    fixedSpeed: "Системная скорость", detectedSpeed: "Определённая скорость", automaticSpeed: "Скорость автоматического ключа", correct: "Верно", wrong: "Неверно", waiting: "Ожидание ввода",
    attempts: "Попытки", correctCount: "Верно", accuracy: "Точность", rhythm: "Средний ритм", weak: "Слабые знаки", noWeak: "Нет",
    manualHint: "Удерживайте Пробел для передачи", paddleHint: "Z точка / X тире", sim: "Все позывные — вымышленные SIM-станции, созданные программой",
    session: "Эта сессия", lifetime: "Общая статистика", recordingTo: "Запись в", sessionOnly: "Только эта сессия · выберите сохранение, чтобы оставить результаты",
    endSession: "Завершить сессию", summaryTitle: "Итоги сессии", summarySubtitle: "Эта тренировочная сессия оценена", continueTraining: "Продолжить тренировку", leavePractice: "Назад к заставке",
    difficulty: "Сложность", guided: "С подсказками", standard: "Стандарт", challenge: "Испытание", lesson: "Урок", lessonProgress: "Прогресс урока",
    pass: "Урок пройден", retry: "Цель не достигнута — повторить", unlocked: "Следующий урок открыт", completed: "Курс завершён", switchLocked: "Переключение произойдёт в следующем раунде после ответа",
    lessonContents: "Содержание урока", introduced: "Новое в уроке", practiceRange: "Набор заданий", masteryProgress: "Прогресс прохождения урока",
    completedLessons: "Завершённые уроки", currentBlock: "Текущий зачётный блок", passRule: "Условие прохождения", remainingQuestions: "Осталось вопросов", correctNeeded: "Нужно верных ответов",
    thresholdSecured: "Нужное число верных ответов достигнуто; завершите оставшиеся вопросы", cannotPass: "Этот блок уже нельзя пройти; завершите его для перезапуска", blockProgressing: "Продолжайте текущий зачётный блок", blockNotStarted: "Подсчёт этого урока ещё не начат",
    replayNoProgress: "Повтор завершённого урока не продвигает текущий зачётный блок", curriculumOverview: "Курс",
    callsignRegion: "Регион позывного", callsignRegions: { all: "Все", japan: "Япония", usa: "США", china: "Китай", europe: "Европа" },
    weakReview: "Отработка слабых целей", weakReviewActive: "Идёт отработка", weakReviewTargets: "Набор для отработки", weakReviewUnavailable: "Доступно после ошибки",
    weakReviewRecoveryHint: "Верные ответы снижают вес слабости этого знака", recoveredPoints: "Восстановлено", remainingWeakness: "Остаток слабости",
    weakReviewComplete: "Отработка слабых целей завершена", weaknessMastered: "Слабая цель освоена", weaknessMasteredDetail: "Вес слабости равен нулю, поэтому цель не войдёт в следующую отработку; прогресс основного урока не меняется", weakReviewNoProgress: "Общая статистика обновлена; прогресс основного урока не изменился", returnToLesson: "Вернуться к уроку",
  },
};
