...
const TEXT = {
  "zh-CN": {
    ...
    replyTitle: "交换报告并结束", replyBody: "REMOTE 表示你从声音中抄收的远方台呼号，不要发送单词 REMOTE。听不清可发送 AGN K。", replyHint: "远方台呼号 → DE → 本台呼号 → RST → 559 → 73",
    ...
    errors: { missingCq: "缺少 CQ。", missingDe: "缺少 DE。", missingPlayerCallsign: "缺少你的呼号。", wrongCqOrder: "顺序应为 CQ、DE、本台呼号、K。", missingK: "结尾缺少 K。", missingCallsign: "必须包含双方呼号。", invalidRst: "RST 必须是三位有效报告，例如 559。", missing73: "结束电文缺少 73。", invalidAgn: "请求重发请发送 AGN K。" },
  },
  "zh-TW": {
    ...
    replyTitle: "交換報告並結束", replyBody: "REMOTE 代表你從聲音中抄收的遠方臺呼號，不要發送單字 REMOTE。聽不清可發送 AGN K。", replyHint: "遠方臺呼號 → DE → 本臺呼號 → RST → 559 → 73",
    ...
    errors: { missingCq: "缺少 CQ。", missingDe: "缺少 DE。", missingPlayerCallsign: "缺少你的呼號。", wrongCqOrder: "順序應為 CQ、DE、本臺呼號、K。", missingK: "結尾缺少 K。", missingCallsign: "必須包含雙方呼號。", invalidRst: "RST 必須是三位有效報告，例如 559。", missing73: "結束電文缺少 73。", invalidAgn: "請以 AGN K 請求重發。" },
  },
  ja: {
    ...
    replyTitle: "レポートを交換して終了", replyBody: "REMOTE は音からコピーした相手局コールの代用表示です。REMOTE という語は送信しません。聞き取れなければ AGN K。", replyHint: "相手局コール → DE → 自局コール → RST → 559 → 73",
    ...
    errors: { missingCq: "CQ がありません。", missingDe: "DE がありません。", missingPlayerCallsign: "自局コールがありません。", wrongCqOrder: "CQ、DE、自局コール、K の順に送信します。", missingK: "末尾に K が必要です。", missingCallsign: "両局のコールが必要です。", invalidRst: "RST は 559 など有効な3桁で送信します。", missing73: "終了電文に 73 がありません。", invalidAgn: "再送要求は AGN K で送信します。" },
  },
  en: {
    ...
    replyTitle: "Exchange reports and close", replyBody: "REMOTE stands for the callsign you copied by ear; do not transmit the word REMOTE. Send AGN K if you need a repeat.", replyHint: "REMOTE CALL → DE → YOUR CALL → RST → 559 → 73",
