...
const TEXT = {
  "zh-CN": {
    ...
    logTitle: "保存通联日志", logBody: "通联已完成。按 F3 保存日志并结算金钱。", logHint: "F3 → 日志 → 金钱",
  ...
  "zh-TW": {
    ...
    logTitle: "儲存通聯日誌", logBody: "通聯已完成。按 F3 儲存日誌並結算金錢。", logHint: "F3 → 日誌 → 金錢",
  ...
  ja: {
    ...
    logTitle: "交信ログを保存", logBody: "交信完了。F3 でログを保存し報酬を精算します。", logHint: "F3 → ログ → 報酬",
  ...
  en: {
    ...
    logTitle: "Save the QSO log", logBody: "The contact is complete. Press F3 to save the log and settle money.", logHint: "F3 → LOG → MONEY",
  ...
  es: {
    ...
    logTitle: "Guarda el registro QSO", logBody: "El contacto ha terminado. Pulsa F3 para guardar el registro y liquidar dinero.", logHint: "F3 → REGISTRO → DINERO",
  ...
  de: {
    ...
    logTitle: "QSO-Log speichern", logBody: "Der Kontakt ist abgeschlossen. Drücke F3, um das Log zu speichern und Geld abzurechnen.", logHint: "F3 → LOG → GELD",
  ...
  ru: {
    ...
    logTitle: "Сохраните журнал QSO", logBody: "Связь завершена. Нажмите F3, чтобы сохранить журнал и начислить деньги.", logHint: "F3 → ЖУРНАЛ → ДЕНЬГИ",
