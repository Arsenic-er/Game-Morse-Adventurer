...
**v0.37.0**: Kapitel 5 ist jetzt vollständig umgesetzt: NOVA–SORA–MORSE-Handlungsfolge, archivgestützte Lichterkarte und Historie, Jahresrekorde, Stempel, Erfolge, Hinweise nach Fehlschlägen, stabile Personen-/Stationsidentitäten sowie sicheres Pausieren und Beenden. Kapitel 6 ist spielbar als vertikaler Ausschnitt „Berg-Feldstation“: einen von drei fiktiven Orten wählen, geliehenes Funkgerät, Drahtantenne und Batterie aufbauen, einen schwachen Austausch retten, die vorgeschriebenen QTH-/PWR-/ANT-Angaben senden und genau einmal abrechnen, ohne die dauerhafte Ausrüstung zu verändern. Kapitel 7 enthält nur die Grundlage: die Seite Personen & QSL, unveränderliche personengebundene Karten und die festen Entscheidungen glauben / Prüfung anfordern / vertagen. Das vollständige Kapitel 7 und die Kapitel 8–15 bleiben geplant; Notfunk und spätere Handlungssysteme werden nicht als umgesetzt ausgegeben.
...
- Drei lokale Speicherplätze mit einem bis zu sieben Zeichen langen Rufzeichen in Großbuchstaben, festem Startort, austauschbarer Ausrüstung und Geld.
...
- Vom Spieler eingeleiteter fiktiver QSO-Ablauf: Der Empfänger öffnet automatisch, der Spieler ruft CQ, die Ausbreitung bestimmt, ob eine Station antwortet, und ein erfolgreicher Kontakt setzt sich mit Rufzeichen, RST, 73/SK, Geld und Logbucheintrag fort.
...
- Dauerhafte QSO-Ergebnisseiten und Logbucheinträge enthalten Rufzeichen, Region, Entfernung, RST, Ausbreitung, Ausrüstung, WPM, Sendegenauigkeit, Rhythmus, Anzahl der Wiederholungsanforderungen und eine zeilenweise Betriebsauswertung angenommener, gesendeter, abgelehnter und wiederholter Versuche.
- Jedes abgerechnete QSO speichert eine dauerhafte Aufschlüsselung in sieben Sprachen: 100 Basis-Geld, +50 für selbstständige Wache, +75 für eine P0–P2-Schwachsignalverbindung, +20 für die erste Region und +25 für einen neuen Entfernungsrekord. Ergebnisseite und Home-Logbuch lesen dieselbe Schema-v6-Aufschlüsselung; ältere Logs behalten ihre historische Summe ohne nachträgliche Auszahlung.
...
- Atomare, idempotente Geldabrechnung verhindert, dass ein abgeschlossenes QSO mehr als einmal belohnt wird.
- Die Stationsentwicklung nach Kerbal-Vorbild trennt Technologiepunkte von Geld: 14 zunehmend schwierigere QSO-Forschungsprojekte finanzieren 28 Knoten in Funktechnik, Antennen, Signalverarbeitung, Energie und Automatisierung. Implementierte Knoten schalten Käufe frei; sichtbare Zukunftsknoten kosten noch keine Punkte.
...
- Das erste Ersatzfunkgerät, das fiktive MICA-8, kostet 800 Geld und ist von offenen uSDX/uSDR-QRP-Konzepten inspiriert: ein 5-W-Hardwareprofil für acht Bänder, 20 % weniger Empfängerrauschen, 15 % geringere wahrgenommene QSB-Tiefe durch AGC sowie getrennte Pixelgrafiken für Leerlauf und TX, deren rote Diode nur beim Senden leuchtet. Der aktuelle Spielbetrieb bleibt auf 21,060 MHz CW festgelegt.
- Ein einzelner Zubehörplatz unterstützt den 300 Geld teuren CW-500-Audiofilter mit 650 Hz Mittenfrequenz, 500 Hz Bandbreite und 35 % weniger Empfängerrauschen; das ausgerüstete Zubehör wird im QSO-Log gespeichert.
...
Die automatisierte Testsuite deckt CW-Kern und wiederholenden Keyer, Empfänger-Audiofilterung, Übungsengine, regionale Kataloge und Pools fiktiver Rufzeichen, Migration auf Schema v3, Isolation und Neuladen von Einstellungen, Sperrung der Regionswahl, Lehrplanübersichten für vier Modi, Isolation des Schwächen-Wiederholungspools, Schwächenabbau, dauerhaften Lernstand und Invarianten formaler Lektionen ab. Ebenfalls geprüft werden die Blindempfang-QSO-Zustandsmaschine, strikte QSO-Reihenfolge und `AGN K`-Wiederholungen, Verlauf der Betriebsauswertung, Berechtigung für selbstständige Wachen, CQ-Antwortwahrscheinlichkeit, dauerhafte QSO-Logs und Ergebnisse, Ableitung von Erfolgen, idempotente Geldabrechnung, Shop-Wirtschaft, Besitz und Ausrüstung von Funkgeräten und Zubehör, Ausbreitungsmodell, Kartenprojektion und Speicherregeln.

## Projektstatus

Version **v0.33.0** ersetzt die binäre CQ-Formatprüfung durch eine simulierte Mitschrift der Gegenstation. Jeder gesendete Ruf wird mit mehreren gültigen CQ-Formen verglichen und anschließend mit Rufzeichenerkennung, Reihenfolge, Rhythmus, Spielertempo, Ausbreitung und Empfangsfähigkeit des Operators bewertet. Zehn fiktive Rufzeichen verwenden sieben experimentelle Profile mit unterschiedlichem Vorzugstempo, Können, Geduld, Verfahrensstrenge, Reaktionszeit, Antwortlänge und Rückfragestil. Ein klarer Ruf erhält eine gerichtete Antwort; teilweise Mitschrift kann `?`, `AGN?`, `QRZ?` oder `QRS?` auslösen; ein erkennbarer, aber unlesbarer Ruf kann zu einem allgemeinen CQ führen, völliges Durcheinander oder ein knapper Operator bleiben eventuell still. Schema-v6-Logs speichern CQ-Qualität, Mitschriftwert, Ergebnis, Profil, Gegenstations-WPM und Rückfragen. Der QSO-Verlassschutz aus v0.25 und alle sieben Sprachen bleiben erhalten. Dasselbe Gegenstationsmodell bewertet nun auch den RST/73-Rapport des Spielers: Teilweise Mitschrift führt zu `AGN? K` oder `QRS? K`, ein unlesbarer Rapport bleibt wiederholbar, und erst eine vollständig aufgenommene Wiederholung schließt das QSO ab und rechnet es ab. In v0.28 stellen fünf der zehn fiktiven Stationen je nach Persönlichkeit optional eine Frage zu Leistung, QTH, Wetter, einem erfundenen Namen oder einem erfundenen Alter; die anderen fünf bleiben beim kurzen Austausch. `AGN K` wiederholt die Frage, `SKIP K` oder `73 K` überspringt sie, und Schema-v6-Logs speichern nur Frage, Ergebnis und Wiederholungszahl, niemals den Antworttext. Die fertigen Ausdrucksbögen für MORSE, WANG, NOVA, DIEGO und SORA werden ausschließlich im privaten Asset-Repository archiviert; sie werden nicht ausgeliefert, geladen oder während eines Funkkontakts angezeigt. In Rapport- und optionalen Austauschphasen fordert `QRS K`, `QRS PSE K` oder `PSE QRS K` dieselbe Nachricht derselben Station langsamer an, behält Ausbreitung und Belohnungen bei und endet bei 5 WPM. v0.30 ergänzt eine versionierte, seed-basierte Grundlage für eine konzeptionelle Population von 100.000 fiktiven Operatoren in JP, US, CN, DE, CH und FI. Profile werden bei Bedarf rekonstruiert; künftige Spielstände benötigen nur einen kleinen Welt-Header und Änderungen bereits angetroffener NPCs. Siebenstellige `SIM`-Rufzeichen sind pro Seed eindeutig, und `pnpm npc:generate` dient zur ausdrücklichen Vorschau oder Streaming-Ausgabe. Die Live-QSO-Auswahl verwendet das System noch nicht. v0.31 ergänzt eine Löschgeste während des Sendens: Sieben gleiche Punkte oder Striche in Folge löschen nur die noch nicht gesendete Eingabe; sechs Elemente, gemischte Elemente oder eine Zeichenpause lösen sie nicht aus. v0.33.0 behandelt zusammengeschriebene Wörter, timingbedingte Trennungen im Rufzeichen und den üblichen Abschluss `PSE K` als gleichwertige gültige CQ-Stile; bei wirklich verstümmelten Signalen entscheiden weiterhin Operatorpersönlichkeit und Ausbreitung.
...
- v0.33.0 ersetzt Stations-Credits durch ein kompatibles Geldkonto, ergänzt ein atomares Einmal-Belohnungsbuch und erweitert Medaillen um Kontakt, Expedition, Betrieb, Ausrüstung und Personen. Alte Credits werden 1:1 migriert; bereits erreichte Medaillen bleiben ohne rückwirkende Auszahlung erhalten. Der umsetzungsreife Entwurf `Das unvollendete Logbuch` definiert 15 Kapitel, Jahreskalender, Missions-DNA und den Offene-Station-Modus nach der Handlung.
