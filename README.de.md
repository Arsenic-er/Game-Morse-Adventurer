...
- Ein QSO ohne Führung und ohne Öffnen der visuellen Hilfe gilt als selbstständige Wache und gewährt zusätzlich zur Grundbelohnung von 100 Credits weitere 50 Credits.
...
Version **v0.23.0** erweitert die gesamte Spieloberfläche auf Englisch, vereinfachtes Chinesisch, traditionelles Chinesisch, Japanisch, Spanisch, Deutsch und Russisch. Spanisch, Deutsch und Russisch verwenden die OFL-lizenzierte Pixelschrift Press Start 2P; Englisch, Chinesisch und Japanisch behalten Fusion Bold Pixel. Außerdem bleibt das regionale Training mit fiktiven Rufzeichen aus v0.22 erhalten: Alle behält den bestehenden Pool mit acht Zielen; Japan, Vereinigte Staaten, China und Europa stellen jeweils acht eindeutige `SIM`-Ziele bereit, die über vier Lektionen als 2/4/6/8 freigeschaltet werden. Gemischter Beutel, Vermeidung der letzten vier Ziele und Schwächenwiederholung bleiben im aktuell freigeschalteten Pool der gewählten Region. Übungsdatenschema v3 migriert ältere Spielstände zu Alle, stellt nach dem Neuladen Region und passenden Pool wieder her und leert bei einem Regionswechsel das gesamte Fenster der zuletzt verwendeten Rufzeichen, bewahrt jedoch Langzeitergebnisse, Schwächen, formale Lektionswertung, Freischaltungen und den zusammengefassten Fortschritt aller 19 Lektionen. Jede akzeptierte Änderung an `main` wird als portables Windows-x64-Artefakt mit Prüfsumme paketiert.
