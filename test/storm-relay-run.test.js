...
test("source verification exposes the canonical revision-two packet", () => {
  ...
  assert.deepEqual(run.summary, {
    ...
    controlPersonId: "person:procedural:chapter12-control",
    controlStationId: "station:procedural:chapter12-control",
    relayPersonId: "person:procedural:chapter12-relay",
    relayStationId: "station:procedural:chapter12-relay",
